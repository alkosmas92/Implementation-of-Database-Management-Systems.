...
int main() {
	...
	strcpy(empName, "EMP-NAME.txt");
	strcpy(empAge, "EMP-AGE.txt");
	strcpy(empSal, "EMP-SAL.txt");
	strcpy(empDname, "EMP-DNAME.txt");
	strcpy(deptName, "DEPT-NAME.txt");
	strcpy(fltname, "EMP-FAULT.txt");
